...
#define IM_ASSERT(_EXPR)  ET_ASSERT(_EXPR)
...
#	define ET_CT_IMGUI ET_ENABLED
#else
#	define IMGUI_DISABLE                                     // Disable everything: all headers and source files will be empty.
#	define ET_CT_IMGUI ET_DISABLED
...
#define IM_VEC2_CLASS_EXTRA                                                     \
        constexpr ImVec2(et::vec2 const& f) : x(f.x), y(f.y) {}                   \
        operator et::vec2() const { return et::vec2(x,y); }

#define IM_VEC4_CLASS_EXTRA                                                     \
        constexpr ImVec4(et::vec4 const& f) : x(f.x), y(f.y), z(f.z), w(f.w) {}   \
        operator et::vec4() const { return et::vec4(x,y,z,w); }
...
#define IM_DEBUG_BREAK()  ET_BREAK()
