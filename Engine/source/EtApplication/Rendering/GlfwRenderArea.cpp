...
void GlfwRenderArea::Initialize(rhi::RenderDeviceParams const& params, bool const hidden, core::WindowSettings const& windowSettings)
{
	...
	glfwWindowHint(GLFW_TITLEBAR, windowSettings.m_Decorated ? GLFW_TRUE : GLFW_FALSE);
	glfwWindowHint(GLFW_RESIZABLE, true); // #todo: make this a setting
	...
	glfwSetWindowAttrib(m_Window.Get(), GLFW_RESIZABLE, GLFW_TRUE);
