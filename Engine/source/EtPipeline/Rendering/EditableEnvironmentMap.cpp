...
#include <EtPipeline/RHI/Import/CompressedCube.h>
...
{
	RefPtr<render::EnvironmentMapAsset> mainAsset = Create<render::EnvironmentMapAsset>(*static_cast<render::EnvironmentMapAsset*>(m_Asset.Get()));
	m_RuntimeAssets.emplace_back(mainAsset, true);

	RefPtr<rhi::TextureAsset> envCubeMapAsset = Create<rhi::TextureAsset>();
	...
	RefPtr<rhi::TextureAsset> irradianceAsset = Create<rhi::TextureAsset>();
	...
	RefPtr<rhi::TextureAsset> radianceAsset = Create<rhi::TextureAsset>();
...
{
	render::EnvironmentMapAsset const* const envMapAsset = static_cast<render::EnvironmentMapAsset const*>(m_Asset.Get());
