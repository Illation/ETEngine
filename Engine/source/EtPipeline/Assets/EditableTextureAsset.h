...
private:
	...
	uint8 GetBlockByteCount(render::E_ColorFormat const format) const;
	bool CompressImage(RasterImage const& image, render::E_ColorFormat const format, std::vector<uint8>& outData) const;
