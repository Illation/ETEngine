...
public:
	...
	// Functionality
	//--------------
	void UploadData(void const* const data, E_ColorFormat const layout, E_DataType const dataType, int32 const mipLevel); // upload an image
