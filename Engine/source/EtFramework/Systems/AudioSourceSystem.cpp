...
//
void AudioSourceSystem::Translate::Process(ComponentRange<AudioSourceSystem::TranslateView>& range) const
{
...
//
void AudioSourceSystem::State::Process(ComponentRange<AudioSourceSystem::StateView>& range) const
{
