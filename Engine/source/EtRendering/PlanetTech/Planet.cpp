...
void Planet::Init(PlanetParams const& params, core::T_SlotId const nodeId)
{
	...
	m_TexDiffuse = core::ResourceManager::Instance()->GetAssetData<rhi::TextureData>(params.texDiffuseId);
	m_TexDetail1 = core::ResourceManager::Instance()->GetAssetData<rhi::TextureData>(params.texDetail1Id);
	m_TexDetail2 = core::ResourceManager::Instance()->GetAssetData<rhi::TextureData>(params.texDetail2Id);

	m_TexHeight = core::ResourceManager::Instance()->GetAssetData<rhi::TextureData>(params.texHeightId);
	m_TexHeightDetail = core::ResourceManager::Instance()->GetAssetData<rhi::TextureData>(params.texHeightDetailId);
