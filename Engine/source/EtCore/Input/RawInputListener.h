...
public:
	...
	virtual bool ProcessMouseEnterLeave(bool const entered, T_KeyModifierFlags const modifiers) = 0;

	virtual bool ProcessTextInput(E_Character const character) = 0;
};
